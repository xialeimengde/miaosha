...
#define DEFAULT_MYSQL_HOME "/usr/local/zftmysql"
#define SHAREDIR "/usr/local/zftmysql/share"
#define DEFAULT_BASEDIR "/usr/local/zftmysql"
#define MYSQL_DATADIR "/data/zftMysqlData"
#define DEFAULT_CHARSET_HOME "/usr/local/zftmysql"
#define PLUGINDIR "/usr/local/zftmysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/zftmysql/etc"
